  ...
  render() {
    return (
      <div id="chartsandbox" className="container">
        ...
        <p className="font-weight-bold">Upon each carefully selected dataset, the marvelous Master Chart<sup>TM</sup> would have been populated for the user to compare magnitude and better understand each Bitcoin dataset.</p>
