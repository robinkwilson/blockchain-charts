  ...
  render() {
    return (
      <div id="chartsandbox" className="container">
        ...
        <p>Upon each carefully chosen dataset, the marvelous Master Chart<sup>TM</sup> would have been populated for the user to compare magnitude and better understand each Bitcoin dataset.</p>
        <p>Alas, my dear friend. It was simply not meant to be.</p> 
        <p>Please enjoy a photo of a silly kitten.</p>
